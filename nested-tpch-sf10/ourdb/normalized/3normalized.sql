...
from
        ourdb.parquetview('nestedcustomer_0.parquet') c inner join ourdb.parquetview('nestedcustomer_1.parquet') o on c._sk = o._psk0 inner join ourdb.parquetview('nestedcustomer_2.parquet') l on o._sk = l._psk1
where
