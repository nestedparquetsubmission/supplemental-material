...
from
        ourdb.parquetview('nestedregion_2.parquet') c inner join ourdb.parquetview('nestedregion_3.parquet') o on c._sk = o._psk2 inner join ourdb.parquetview('nestedregion_4.parquet') l on o._sk = l._psk3
where
